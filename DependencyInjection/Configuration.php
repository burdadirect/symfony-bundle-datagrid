        ...
        ->arrayNode('session')->addDefaultsIfNotSet()
          ->children()
            ...
            ->arrayNode('use_for')
              ...
              ->defaultValue(array('num', 'sort', 'extended'))
            ->end()
          ->end()
        ->end()
        ...
        ->arrayNode('menu')->addDefaultsIfNotSet()
          ->children()
            ...
            ->arrayNode('exports_selection')
              ->prototype('scalar')->end()
              ->defaultValue(array('csv', 'xlsx', 'json'))
            ->end()
            ->arrayNode('exports_resources')->defaultValue(array('max_execution_time' => 60))->useAttributeAsKey('key')
              ->prototype('array')
                ->children()
            ...
            ->arrayNode('max_entries_selection')
              ->prototype('scalar')->end()
              ->defaultValue(array(10, 20, 50, 100, 250))
            ->end()
          ->end()
        ->end()
      ->end()
