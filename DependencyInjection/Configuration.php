    ...
    $rootNode
      ->children()
        ...
        ->arrayNode('bootstrap')->addDefaultsIfNotSet()
          ->children()
            ->scalarNode('version')->defaultValue('v3')->end()
              ->arrayNode('sizes')->addDefaultsIfNotSet()
                ->children()
                  ->scalarNode('btn')->defaultValue('')->end()
                  ->scalarNode('btn-group')->defaultValue('')->end()
                  ->scalarNode('input-group')->defaultValue('')->end()
            ...
            ->arrayNode('classes')->addDefaultsIfNotSet()
              ->children()
                ...
                ->scalarNode('btn-group')->defaultValue('btn-group')->end()
                ->scalarNode('input-group')->defaultValue('input-group')->end()
                ...
                ->scalarNode('page-item')->defaultValue('page-item')->end()
                ->scalarNode('page-link')->defaultValue('page-link')->end()
              ->end()
            ->end()
            ->arrayNode('icons')->addDefaultsIfNotSet()
              ->children()
                // Sortation
                ->scalarNode('sort-asc')->defaultValue('fa fa-sort-amount-asc')->end()
                ->scalarNode('sort-desc')->defaultValue('fa fa-sort-amount-desc')->end()
                // Navigation
                ...
                // Pagination
                ->scalarNode('page-first')->defaultValue('fa fa-fast-backward')->end()
                ->scalarNode('page-prev')->defaultValue('fa fa-step-backward')->end()
                ->scalarNode('page-next')->defaultValue('fa fa-step-forward')->end()
                ->scalarNode('page-last')->defaultValue('fa fa-fast-forward')->end()
              ->end()
            ->end()
          ->end()
        ->end()
