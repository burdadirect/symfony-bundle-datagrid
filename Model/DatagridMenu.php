...
class DatagridMenu {
	...
	public function setShowSearch($showSearch) { $this->showSearch = $showSearch; }
	public function getShowSearch() { return $this->showSearch; }

	public function setSearchFields($searchFields) { $this->searchFields = $searchFields; }
	public function getSearchFields() { return $this->searchFields; }

	public function setSearchValues($searchValues) { $this->searchValues = $searchValues; }
	public function getSearchValues() { return $this->searchValues; }

	public function setShowReset($showReset) { $this->showReset = $showReset; }
	public function getShowReset() { return $this->showReset; }

	public function setShowRange($showRange) { $this->showRange = $showRange; }
	public function getShowRange() { return $this->showRange; }

	public function setShowHeader($showHeader) { $this->showHeader = $showHeader; }
	public function getShowHeader() { return $this->showHeader; }

	public function setShowMaxEntriesSelection($showMaxEntriesSelection) { $this->showMaxEntriesSelection = $showMaxEntriesSelection; }
	public function getShowMaxEntriesSelection() { return $this->showMaxEntriesSelection; }

	public function setMaxEntriesSelection($maxEntriesSelection) { $this->maxEntriesSelection = $maxEntriesSelection; }
	public function getMaxEntriesSelection() { return $this->maxEntriesSelection; }
	...
	public function setRouteReset(Route $routeReset) { $this->routeReset = $routeReset; }
	public function getRouteReset() { return $this->routeReset; }

	public function setRouteSearch(Route $routeSearch) { $this->routeSearch = $routeSearch; }
	public function getRouteSearch() { return $this->routeSearch; }
